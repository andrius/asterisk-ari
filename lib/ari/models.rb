...
require 'ari/models/asterisk_ping'
require 'ari/models/module'
require 'ari/models/log_channel'
require 'ari/models/variable'
require 'ari/models/config_tuple'
...
require 'ari/models/contact_info'
require 'ari/models/peer'
require 'ari/models/device_state_changed'
require 'ari/models/playback_started'
require 'ari/models/playback_continuing'
...
require 'ari/models/application_move_failed'
...
require 'ari/models/bridge_video_source_changed'
...
require 'ari/models/contact_status_change'
require 'ari/models/peer_status_change'
